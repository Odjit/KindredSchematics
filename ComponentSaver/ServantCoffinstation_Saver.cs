...
namespace KindredSchematics.ComponentSaver
{
    ...
    internal class ServantCoffinstation_Saver : ComponentSaver
    {
        ...
        {
            var saveData = jsonData.Deserialize<ServantCoffinstation_Save>(SchematicService.GetJsonOptions());
        ...
        {
            var saveData = data.Deserialize<ServantCoffinstation_Save>(SchematicService.GetJsonOptions());
